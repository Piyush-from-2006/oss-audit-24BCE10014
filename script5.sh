...
# --- Interactive User Input (Unit 5 Concept) ---
...
# Using a subshell and the '>' redirection operator to capture multiple echo statements
{
    echo "=========================================================="
...
# --- Progress Indicator ---
# Using a for loop to simulate a "compiling" effect for the report
